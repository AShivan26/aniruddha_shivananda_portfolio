...
export const workExperiences = [
  {
    ...
    title: "Engineered APIs for a mobile check-in app, reducing checkout time by 70% and supporting 10,000 daily checkouts. Improved code coverage from 58% to 85%, reduced API response time by 50% using Kafka and Redis, and implemented scalable architectures with gRPC, REST, and OAuth2. Enhanced monitoring, cutting downtime by 10%.",
  ...
  },
  {
    ...
    title: "Developed a Mobile Check-In Application for vehicle rentals, integrating a responsive React frontend with a Spring Boot backend. Achieved 100% service layer test coverage using SonarQube and SpotBugs, eliminating technical debt. Leveraged Open API specifications for seamless integration, automated code generation, and ensured API consistency with finalized contracts.",
    icon: '/assets/sixt.svg',
    animation: 'clapping',
  },
  {
