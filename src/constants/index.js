...
export const clientReviews = [
  {
    ...
    review:
      ...
      '\n' +
      'Due to his outstanding performance, He was offered a full-time position as a Software Development Engineer (SDE) starting on August 17, 2022. During his tenure, which lasted until July 8, 2024, he made remarkable contributions to our Mobile Check-in Service APIs. His work reduced checkout time from 10 minutes to 3 minutes and increased adaptability from 2% to 6%, enabling 10,000 daily checkouts with uninterrupted service availability. He implemented advanced techniques such as Request Level Caching and Redis caching, resulting in an exceptional API response time of approximately 300 milliseconds, significantly enhancing user experience.\n' +
      '\n' +
      'His commitment to code quality was evident as he enhanced code coverage from 60% to an impressive 85%, ensuring superior code quality and maintaining a high Customer Evaluation Score (CES) rating. He successfully deployed Kafka funnels to enable seamless tracking, monitoring, and data storage, enhancing data processing efficiency. Additionally, he implemented configurable validation chaining across all APIs, resulting in a notable reduction of latency by 30% to 40% while improving code readability and maintainability.\n' +
      '\n' +
      'He also automated the clean-up process of the rental database through cron jobs, efficiently removing redundant data and streamlining operations previously performed manually, especially for older data sets. He implemented Kibana, Prometheus, Grafana, and Opsgenie for proactive monitoring, resulting in a 20% boost in customer experience by swiftly addressing critical API failures. His work on P100 API’s onboarding, coverage add-ons, and payment APIs, as well as removing circular dependencies from the repository, further demonstrated his technical prowess and dedication.\n' +
      '\n' +
      'On a personal level, Aniruddha is always open to learning more and puts incredible effort into going the extra mile. He is kind, open to his colleagues, and fun to work with. Although he decided to relocate to the US for higher studies, he would have remained a crucial member of our team had he stayed. I am confident that he will excel in any future role he undertakes. He has my highest recommendation, and I wish him all the best in his future endeavors.',
  },
  {
    id: 2,
    name: 'Ammar Ahmad',
  ...
  },
  {
    ...
    review:
      ...
      '\n' +
      'I deeply admire his focus, integrity, and exceptional problem-solving skills. He approaches tasks with diligence, setting a commendable example for the team. His ability to analyse situations critically and deliver effective solutions is truly commendable.\n' +
      '\n' +
  ...
  },
  {
    ...
    review:
      ...
      '\n' +
      'Transitioning into the role of an SDE 1, He seamlessly integrated into our team, bringing with him a strong work ethic and a proactive approach to problem-solving. Despite being relatively new to the position, he demonstrated a remarkable level of ownership and professionalism. His collaborative spirit, coupled with his attention to detail, has been invaluable in driving the success of our projects and team dynamics. I do not doubt that Aniruddha will continue to excel and make significant contributions in any future role or endeavor he undertakes. \n' +
      '\n' +
...
export const myProjects = [
  ...
  {
    title: 'XINU Operating System Enhancements',
    desc: 'Enhanced the XINU Operating System by implementing demand paging with SC and FIFO algorithms, optimizing memory allocation and process management. Introduced system call tracing and advanced process control mechanisms to extend kernel functionality. Developed a disk defragmenter to improve storage efficiency and system performance.',
    subdesc:
    ...
    tags: [
      {
        id: 1,
        name: 'Linux OS',
        path: '/assets/linux.svg',
      },
      {
        id: 2,
        name: 'XINU OS',
        path: '/assets/xinu.png',
      },
      {
        id: 3,
        name: 'C',
        path: 'assets/c-language.png',
      },
      {
        id: 4,
        name: 'x86 Assembly',
...
export const workExperiences = [
  {
    ...
    "title":"Built a full-stack Appliance Reservation System using Angular and PHP to enable users and administrators to manage StorageGRID appliance reservations through a unified web interface, complemented by dashboards for model-wise utilization and capacity planning. Automated the retrieval of power supply, firmware, and hardware metadata to enhance inventory visibility, while optimizing caching pipelines to reduce execution time from 6 hours to 2 hours. Engineered a Python and PHP–based hardware remediation pipeline for intent extraction and eligibility validation, reducing processing latency by 98% and saving over 10 hours of manual administrative effort weekly. Developed a RAG-driven triage system leveraging ChromaDB for semantic retrieval across Mantis and Jira logs, enabling automated root-cause analysis that reduced support latency by 40% and improved resolution efficiency by 35%. Additionally, built a Model Context Protocol (MCP) server in Go to enable natural language–driven interaction with StorageGRID Management APIs, reducing manual API operations by 60% and accelerating administrative workflows by 3×, and designed a scalable Agent-to-Agent (A2A) and MCP-based interface layer that improved system accessibility and reduced onboarding time for new operators by 50%.",
  ...
  },
  {
    ...
    title: "Developed a scalable multi-router Thread network using OpenThread FTDs on Raspberry Pi and nRF52840, enabling efficient low-power mesh routing over IEEE 802.15.4, with isolated communication via custom PAN ID configurations and seamless device interoperability. Designed a C++ client-server controller leveraging RCP-based OTBRs for IPv6 compression through 6LoWPAN, real-time parent switching using MLE, and VLAN-based mobility via 802.1Q, alongside an orchestration layer to enable automated failover and low-latency network handovers. Extended the Thread stack to support multi-PAN network flattening with multi-PAN IDs, multi-network keys, cross-PAN IPv6 routing, and secure inter-PAN neighbor discovery, reducing topology overhead by 30%, enabling ~50 ms handovers, and improving fault tolerance by 25%. Additionally, implemented automated provisioning for FP-Thread networks using Thread Commissioner (MeshCoP) with per-device Active Operational Dataset assignment, enabling secure onboarding, deterministic routing, and strong device-level isolation without requiring protocol or firmware modifications.",
  ...
  },
  {
    ...
    title: "Engineered a highly efficient and reliable distributed system architecture by implementing a configurable validation chaining strategy and Redis-based caching, halving API response times and improving P99 latency by 40%. Built a multi-layered observability ecosystem with Kibana, Prometheus, Grafana, and OpenTelemetry for anomaly detection, reducing downtime by 10% and streamlining root cause analysis. Enhanced incident management with dynamic Opsgenie triggers and threshold-based alerting, cutting alert noise by 40% and MTTR by 30%. Designed fault-tolerant automation systems using Quartz Scheduler, Kafka Streams, and multi-level caching, improving reliability and reducing manual efforts by 80%. Automated runbook generation in CI/CD pipelines for faster incident triage, and utilized Instana for real-time pod monitoring, mitigating resource issues and achieving 99.99% uptime with a 75% reduction in pod failures.",
    icon: '/assets/sixt.svg',
    animation: 'victory',
  },
  {
    id: 5,
    ...
    title: "Optimized the SIXT car rental checkout process by reducing time from 13 minutes to 2 minutes through a hybrid API architecture combining REST for client-facing services and gRPC for downstream communication, ensuring high performance and scalability. Streamlined API development with OpenAPI/Swagger for automated code generation, reducing integration overhead. Enhanced code quality by increasing test coverage from 58% to 85% using SonarQube and SpotBugs, and refactored legacy code to eliminate technical debt, improving maintainability and performance.",
    icon: '/assets/sixt.svg',
    animation: 'clapping',
  },
  {
    ...
    title: "Analyzed Vulkan and Shared GL graphics APIs in a multi-platform Performance Comparison Study, evaluating key metrics and delivering data-driven recommendations. Contributed critical insights that enhanced the study’s conclusions and outcomes.",
    icon: '/assets/prism.svg',
    animation: 'salute',
  },
];
